...
<head>
	<title>Zenith Broker Trade | Cookie Policy Documentation</title>
	<meta charset="UTF-8" />
	<meta name="title" content="Zenith Broker Trade | Cookie Policy" />
	<meta name="Description" content="View the Zenith Broker Trade cookie policy on this page" />
	<meta name="keywords" content="Zenith Broker Trade cookie policy,Earn money online, Make money online, bitcoin wallets, Education,Elearning,SME Training,Online Training,E-Learning,Manual Handling,Online Education" />
	<meta name="viewport" 
	...
	<meta property="og:title" content="Zenith Broker Trade | Cookie Policy" />
	<meta property="og:description" content="View the Zenith Broker Trade cookie policy on this page" />
...
<h2>Cookies set by Zenith Broker Trade and other third party App</h2>
<p>The Zenith Broker Trade website also makes use of services offered by third party websites such as Jetpack, and webmaster tools amongst others to enhance the experience of visitors. These include social media platforms such as Facebook and Twitter (through the use of sharing buttons). As a result, cookies may be set by these third parties, and used by them to track your online activity. We have no direct control over the information that is collected by these cookies.<br>
Cookies are used by Zenith Broker Trade and other third party Apps running on the Zenith Broker Trade website in a variety of different ways. The cookies set will depend features that are enabled. The cookies are only set when a user interacts with one of these, or to allow admin functions.</p>
